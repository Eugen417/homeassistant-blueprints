...
| **Battery_Report_V3.4_RU.yaml** | **[RU]** Подробный отчет по батарейкам (**Battery Notes**). Группировка по уровню и типу. PUSH, Telegram, VK Notify (Keyboard Edition) и MAX.| [![Import](https://my.home-assistant.io/badges/blueprint_import.svg)](https://my.home-assistant.io/redirect/blueprint_import/?blueprint_url=https%3A%2F%2Fgithub.com%2FEugen417%2Fhomeassistant-blueprints%2Fblob%2Fmain%2FBattery_Report_V3.4_RU.yaml) |
| **script_battery_plus_tg_push_report.yaml** | **[RU]** Скрипт отчета в Telegram (Battery+). Разделяет на «Замена» и «Зарядка». PUSH, Telegram, VK Notify (Keyboard Edition) и MAX.| [![Import](https://my.home-assistant.io/badges/blueprint_import.svg)](https://my.home-assistant.io/redirect/blueprint_import/?blueprint_url=https%3A%2F%2Fgithub.com%2FEugen417%2Fhomeassistant-blueprints%2Fblob%2Fmain%2Fscript_battery_plus_tg_push_report.yaml) |
...
| **weather_smart_3hr_meteoosadki_telegram-report.yaml** | **[RU]** Краткий погодный отчет в Telegram, VK и MAX  (прогноз каждые 3 часа + осадки). | [![Import](https://my.home-assistant.io/badges/blueprint_import.svg)](https://my.home-assistant.io/redirect/blueprint_import/?blueprint_url=https%3A%2F%2Fgithub.com%2FEugen417%2Fhomeassistant-blueprints%2Fblob%2Fmain%2Fweather_smart_3hr_meteoosadki_telegram-report.yaml) |
| **weather_smart_3hr_meteoosadki_vk-report.yaml** | **[RU]** Объединяет в себе два предидущих отправляет отчёт в VK мессенджер роботает только с VK Notify (Keyboard Edition)| [![Import](https://my.home-assistant.io/badges/blueprint_import.svg)](https://my.home-assistant.io/redirect/blueprint_import/?blueprint_url=https%3A%2F%2Fgithub.com%2FEugen417%2Fhomeassistant-blueprints%2Fblob%2Fmain%2Fweather_smart_3hr_meteoosadki_vk-report.yaml) |

## 📊 Notifications & Data / Уведомления и Данные

| File | Description | Install |
| :--- | :--- | :---: |
| **ya_st_alice_simple.yaml** | **[RU]** Визуальный интерфейс настроики уведомлений и команд для интеграции ЯЯндекс.Станция для Home Assistant: Алиса: Умный рупор Multi TTS+Play Media. Мульти-выбор колонок, индивидуальная умная громкость без пиков, база звуков, отправка тихих команд и защита играющей музыки. Лёгкий выбор из библиотек голосов, эффктов и звуков. | [![Import](https://my.home-assistant.io/badges/blueprint_import.svg)](https://my.home-assistant.io/redirect/blueprint_import/?blueprint_url=https%3A%2F%2Fgithub.com%2FEugen417%2Fhomeassistant-blueprints%2Fblob%2Fmain%2Fya_st_alice_simple.yaml) |
...
| **new_waterleackdeteckt_tts_push_notifi.yaml** | **[RU]** Уведомление о протечке воды (TTS на колонки + Push на телефон), Telegram, VK Notify (Keyboard Edition) и MAX.| [![Import](https://my.home-assistant.io/badges/blueprint_import.svg)](https://my.home-assistant.io/redirect/blueprint_import/?blueprint_url=https%3A%2F%2Fgithub.com%2FEugen417%2Fhomeassistant-blueprints%2Fblob%2Fmain%2Fnew_waterleackdeteckt_tts_push_notifi.yaml) |
| **sensor_state_notify.yaml** | **[RU]** Универсальное уведомление при изменении состояния выбранного сенсора в Telegram + Max + VK Notify (Keyboard Edition). | [![Import](https://my.home-assistant.io/badges/blueprint_import.svg)](https://my.home-assistant.io/redirect/blueprint_import/?blueprint_url=https%3A%2F%2Fgithub.com%2FEugen417%2Fhomeassistant-blueprints%2Fblob%2Fmain%2Fsensor_state_notify.yaml) |
...
| File | Description | Install |
| :--- | :--- | :---: |
| **person_tracker_RU.yaml** | **[RU]** Трекер персон. Отслеживание входа/выхода из зон и по запросу актуальное местоположение. | [![Import](https://my.home-assistant.io/badges/blueprint_import.svg)](https://my.home-assistant.io/redirect/blueprint_import/?blueprint_url=https%3A%2F%2Fgithub.com%2FEugen417%2Fhomeassistant-blueprints%2Fblob%2Fmain%2Fperson_tracker_RU.yaml) |
| **vk_person_tracker.yaml** | **[RU]** Трекер персон. Отслеживание входа/выхода из зон и по запросу актуальное местоположение. Работает только с VK Notify (Keyboard Edition) ⌨️. | [![Import](https://my.home-assistant.io/badges/blueprint_import.svg)](https://my.home-assistant.io/redirect/blueprint_import/?blueprint_url=https%3A%2F%2Fgithub.com%2FEugen417%2Fhomeassistant-blueprints%2Fblob%2Fmain%2Fvk_person_tracker.yaml) |
