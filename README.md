...
| File | Description | Install |
| :--- | :--- | :---: |
| **ya_st_alice_simple.yaml** | **[RU]** Визуальный интерфейс настроики уведомлений и команд: Алиса: Умный рупор Multi TTS+Play Media. Мульти-выбор колонок, индивидуальная умная громкость без пиков, база звуков, отправка тихих команд и защита играющей музыки. | [![Import](https://my.home-assistant.io/badges/blueprint_import.svg)](https://my.home-assistant.io/redirect/blueprint_import/?blueprint_url=https%3A%2F%2Fgithub.com%2FEugen417%2Fhomeassistant-blueprints%2Fblob%2Fmain%2Fya_st_alice_simple.yaml) |
