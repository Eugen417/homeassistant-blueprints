...
| **script_battery_plus_tg_push_report.yaml** | **[RU]** Скрипт отчета в Telegram (Battery+). Разделяет на «Замена» и «Зарядка». PUSH, Telegram, VK и MAX.| [![Import](https://my.home-assistant.io/badges/blueprint_import.svg)](https://my.home-assistant.io/redirect/blueprint_import/?blueprint_url=https%3A%2F%2Fgithub.com%2FEugen417%2Fhomeassistant-blueprints%2Fblob%2Fmain%2Fscript_battery_plus_tg_push_report.yaml) |
